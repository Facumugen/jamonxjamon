...
const Card = (props) => {
  ...
  return (
    ...
    <div className="transition-all duration-200 ease-in-out cursor-pointer w-auto rounded-2xl shadow-2xl scale-100 sm:shadow-2xl md:shadow-xl xl:shadow-none hover:shadow-2xl hover:scale-104 bg-[#957C65]">
      ...
      <div className="flex-col w-auto p-5 text-center">
        <h2 className="mb-3 text-2xl capitalize font-extralight text-fontSecondary">{value.title}</h2>
      ...
      <div className="flex-col w-auto p-5 mt-3 font-sans text-center text-zinc-600">
          <p>
            <span className="text-base capitalize md:text-sm font-extralight text-fontSecondary">3 cuotas sin interés de {value.instalments}<br /></span>
    ...
    <Modal modalid={`id${modalValue}`} value={value} />
  ...
  //             </p>
  //         </div>
  //         <button className='text-white bg-black' onClick={()=>addToCart(value.id)}>aaaaaaaaa</button>
  //       </div>
